...
public class ModBlocks {
    ...
    public static final Block BUTCHER_RACK = registerBlock(
            "butcher_rack",
            new ButcherRackBlock(
                    BlockBehaviour.Properties.of()
                            .setId(ResourceKey.create(
                                    Registries.BLOCK,
                                    Identifier.fromNamespaceAndPath(LiveStockHusbandry.MOD_ID, "butcher_rack")
                            ))
                            .strength(1.5F, 2.0F)
                            .sound(SoundType.WOOD)
                            .noOcclusion()
